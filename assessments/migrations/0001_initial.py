# Generated by Django 5.1.1 on 2024-10-23 11:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assessments', to='course.course', verbose_name='Course')),
                ...
                ('exercises', models.ManyToManyField(blank=True, related_name='assessments', to='exercises.exercise')),
                ('questions', models.ManyToManyField(blank=True, related_name='assessments', to='quiz.question')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attempt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='assessments.studentassessmentattempt')),
