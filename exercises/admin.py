...
class ExerciseAdmin(ImportExportModelAdmin):
    ...
    list_display = ('title', 'language', 'description', 'language', 'level', 'test_cases')  # Adjust the fields displayed in the admin
    search_fields = ('title', 'language')  # Search fields for the admin
    list_filter = ('language',)
    
@admin.register(ProgrammingLanguage)
class ProgrammingLangugageAdmin(ImportExportModelAdmin):
