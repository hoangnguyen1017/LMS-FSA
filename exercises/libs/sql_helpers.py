...
def get_mysql_connection():
    ...
    db_config = {
        'host': 'localhost',         # Địa chỉ IP hoặc tên miền của server MySQL
        'port': 3306,           # Cổng kết nối MySQL (thường là 3306)
        'user': 'root',     # Tên người dùng MySQL
        'password': 'TinNT171@437', # Mật khẩu của người dùng MySQL
        'database': 'fsa_db', # Tên database cần kết nối
        'charset': 'utf8mb4'         # Charset để hỗ trợ Unicode
    }
