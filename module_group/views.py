                    ...
                    if not Module.objects.filter(module_name=module_name).exists():
                        try:
                            ...
                            messages.warning(request,
                                             f"ModuleGroup with ID '{module_group_id}' does not exist. Skipping module '{module_name}'.")
                    else:
...
def export_modules(request):
    ...
    for module in Module.objects.all():
        worksheet.append([module.module_name, module.module_url, module.icon, module.module_group.id,
                          module.module_group.group_name])
