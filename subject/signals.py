...
from .models import Document, Video, ReadingMaterial, SubjectMaterial
...
def auto_delete_document_on_delete(sender, instance, **kwargs):
    ...
    # Delete the corresponding SubjectMaterial entry
...
def auto_delete_reading_material_on_delete(sender, instance, **kwargs):
    # No file to delete, but remove the SubjectMaterial entry
