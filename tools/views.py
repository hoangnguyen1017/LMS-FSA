...
#             number_of_questions_per_sheet = 10  # Adjust as needed
...
#                 df = excel_data.parse(name) # hàm parse dùng để đọc toanf bộ dữ liệu và gán vào df
#                 num_rows = len(df)
                
#                 # Ensure the number of questions does not exceed the number of rows
#                 if number_of_questions_per_sheet > num_rows:
#                     number_of_questions_per_sheet = num_rows
                
#                 number_of_questions[name] = number_of_questions_per_sheet
